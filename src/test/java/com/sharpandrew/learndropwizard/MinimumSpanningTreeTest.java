...
public final class MinimumSpanningTreeTest {
    @Test
    public void minimumSpanningTree_emptyGraph() throws Exception {
        runMinimumSpanningTree(ImmutableSet.of(), ImmutableSet.of());
    }

    @Test
    public void minimumSpanningTree_oneEdge() throws Exception {
        runMinimumSpanningTree(ImmutableSet.of(ImmutableEdge.of(1, 2, 3)), ImmutableSet.of(ImmutableEdge.of(1, 2, 3)));
    }

    @Test
    public void minimumSpanningTree_twoEdges() throws Exception {
    ...
    @Test
    public void minimumSpanningTree_threeEdges() throws Exception {
        runMinimumSpanningTree(
    ...
    @Test
    public void minimumSpanningTree_disconnected() throws Exception {
        runMinimumSpanningTree(
